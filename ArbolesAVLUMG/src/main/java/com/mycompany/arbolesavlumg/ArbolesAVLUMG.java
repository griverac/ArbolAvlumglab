...
*
* @autor Álvaro Trigo López
*
* @ versión 5.00 2009/6/14
*/
public  class  ArbolAVL < T > extiende  java . útil _ ConjuntoAbstracto < T >{
    /**
     * Nodo raíz del árbol.
     */
    privado  Nodo < T > raiz ;
    ...
    /**
     * Constructor para recibir el comparador que se ajusta para comparar los elementos. Si
     ...
     */
    public  ArbolAVL ( Comparador < T > cmp ){	
    	esto _ comparador = cmp ;
    }
    ...
    /**
     * Asegura que esta colección contiene el elemento especificado (operación opcional). Devuelve verdadero si esta colección cambió como resultado de la llamada. (Devuelve falso si esta colección no permite duplicados y ya contiene el elemento especificado).
     * Las colecciones que admiten esta operación pueden imponer limitaciones sobre qué elementos se pueden agregar a esta colección. En particular, algunas colecciones se negarán a agregar elementos nulos y otras impondrán restricciones sobre el tipo de elementos que se pueden agregar. Las clases de colección deben especificar claramente en su documentación cualquier restricción sobre qué elementos se pueden agregar.
     * Si una colección se niega a agregar un elemento en particular por cualquier motivo que no sea que ya contiene el elemento, debe generar una excepción (en lugar de devolver falso). Esto conserva la invariante de que una colección siempre contiene el elemento especificado después de que regresa esta llamada.
     * Esta implementación siempre lanza una UnsupportedOperationException.
     *
     * @param e - elemento cuya presencia en esta colección debe ser asegurada.
     * @return true si esta colección cambió como resultado de la llamada.
     * @throws ClassCastException: si la clase del elemento especificado impide que se agregue a esta colección
     * @throws NullPointerException - si el elemento especificado es nulo y esta colección no permite elementos nulos
     * @throws IllegalStateException: si el elemento no se puede agregar en este momento debido a restricciones de inserción
     */
    public  boolean  add ( T  e ) lanza  ClassCastException , NullPointerException , IllegalStateException {
    	Nodo < T > nodo = new  Nodo < T >( e );
    	booleano  salir = false ;
    	 der booleano = falso ;
    	Nodo < T > raizTmp = esto . obtener Raiz ();
	...
	private class Nodo<T>{
		...
		public int getAltura(){
	    	...
	    	devolver  Matemáticas . máx ( hIzq , hDer ) + 1 ;
		}
	}
}
